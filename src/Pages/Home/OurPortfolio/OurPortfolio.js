...
const OurPortfolio = () => {
    return (
        <section className='my-28'>
            <h1 className='text-4xl font-bold flex justify-center items-center mb-4'>OUR PORTFOLIO <span className='ml-3'><img src={headImg} alt="" /></span></h1>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-5 gap-5 mx-10'>
                ...
                <div className='lg:row-start-2 lg:grid-rows-2 lg:row-span-2 lg:col-span-2'>
